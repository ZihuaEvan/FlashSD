...
parser.add_argument(
    "--outdir", type=str, default="../weights3"
)
parser.add_argument(
    "--cpdir", type=str, default="../weights3"
)
...
from flash.model.llama_sar import Model
...
for epoch in range(num_epochs + 1):
    ...
    if accelerator.is_local_main_process:
        ...
        wandb.log({"train/epochacc": correct_sum / max(total_sum, 1), "train/epochloss": epoch_loss, **train_slot_acc_dict})
