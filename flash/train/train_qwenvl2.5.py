...
parser.add_argument(
    "--configpath",
    type=str,
    default="./qwenvl2_5_7B_config.json",
)
...
parser.add_argument(
    "--outdir", type=str, default="../weights/qwen2.5vl"
)
parser.add_argument(
    "--cpdir", type=str, default="../weights/qwen2.5vl"
)
...
for epoch in range(num_epochs + 1):
    ...
    if (epoch + 1) % train_config["save_freq"]:
        ...
        if accelerator.is_local_main_process:
            ...
            torch.save(model.state_dict(), os.path.join(f"{args.cpdir}/state_{epoch}", "pytorch_model.bin"))
