...
#try:
from flash.model.utils import *
from flash.model.ee_model import EeModel
from flash.model.kv_cache import initialize_past_key_values
from flash.model.choices import *
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--ee-model-path",
        type=str,
        default="path/to/eagle_checkpoint",
        help="The path to the weights. This can be a local folder or a Hugging Face repo ID.",
    )
    parser.add_argument("--base-model-path", type=str, default="path/to/Qwen2.5-VL-7B-Instruct",
                        help="1")
    parser.add_argument(
