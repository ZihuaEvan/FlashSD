...
# tokenizer=LlamaTokenizer.from_pretrained("path/to/vicuna-7b/")
...
def initialize_tree(input_ids, pixel_values, model, tree_attn_mask, past_key_values, logits_processor,image_grid_thw=None,):
    tree_logits, outputs, logits, hidden_state, sample_token = model(
        input_ids, pixel_values, image_grid_thw, past_key_values=past_key_values, output_orig=True, logits_processor=logits_processor
    )
