...
class Qwen2_5_VLForConditionalGeneration(Qwen2_5_VLPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        >>> model = Qwen2_5_VLForConditionalGeneration.from_pretrained("Qwpath/to/Qwen2.5-VL-7B-Instruct")
        >>> processor = AutoProcessor.from_pretrained("Qwpath/to/Qwen2.5-VL-7B-Instruct")
